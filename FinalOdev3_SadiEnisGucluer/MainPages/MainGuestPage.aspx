<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainGuestPage.aspx.cs" Inherits="FinalOdev3_SadiEnisGucluer.MainPage" %>
        ...
        <div>
                ...
                <table>
                    <tr>
                        ...
                        <td class="auto-style4">
                            <asp:Button Text="Vasıta" runat="server" ID="Button1" Height="30px" Width="150px" PostBackUrl="~/LogIn.aspx" BackColor="#FF9933" BorderColor="Black" BorderStyle="Solid" BorderWidth="3px" Font-Bold="True" Font-Names="Arial" CssClass="auto-style1"/>                    
                        </td>
                        <td class="auto-style2"><h1>|</h1></td>
                        <td class="auto-style4">
                            <asp:Button Text="Ev" runat="server" ID="Button2" Height="30px" Width="150px" PostBackUrl="~/LogIn.aspx" BackColor="#FF9933" BorderColor="Black" BorderStyle="Solid" BorderWidth="3px" Font-Bold="True" Font-Names="Arial" style="margin-top: 2px; margin-left: 50px;"/>
                        </td>
                        <td class="auto-style2"><h1>|</h1></td>
                        <td class="auto-style4">
                            <asp:Button Text="Arsa" runat="server" ID="Button3" Height="30px" Width="150px" PostBackUrl="~/LogIn.aspx" BackColor="#FF9933" BorderColor="Black" BorderStyle="Solid" BorderWidth="3px" Font-Bold="True" Font-Names="Arial" style="margin-left: 50px"/>
                        </td>
                        <td class="auto-style16"><h1>|</h1></td>
                        <td class="auto-style5">Hoş Geldin <i>Misafir</i></td>
                        <td class="auto-style10"><h1>|</h1></td>
                        <td class="auto-style6">
                            <asp:Button runat="server" ID="btnLogin" Text="Log In" PostBackUrl="~/LogIn.aspx"/>
                        </td>
            ...
            <article>
                <div style="background-color:aliceblue" class="auto-style11">
                    ...
                    <strong>
                    <asp:Button Text="Otomobil İlanı Ver" runat="server" PostBackUrl="~/LogIn.aspx" CssClass="auto-style15" BorderWidth="2px" Height="39px" Width="191px" />
                    <asp:Button Text="Ev İlanı Ver" runat="server" PostBackUrl="~/LogIn.aspx" CssClass="auto-style13" BorderWidth="2px" Width="152px" Height="40px" />
                    <asp:Button Text="Arsa İlanı Ver" runat="server" PostBackUrl="~/LogIn.aspx" CssClass="auto-style12" BorderWidth="2px" Height="40px" Width="160px" />
                    </strong>
                </div>
                <div>
