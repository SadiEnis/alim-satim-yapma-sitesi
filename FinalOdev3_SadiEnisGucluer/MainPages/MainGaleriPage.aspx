<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainGaleriPage.aspx.cs" Inherits="FinalOdev3_SadiEnisGucluer.MainGaleriPage" %>
            ...
            <header>
                <table>
                    <tr>
                        ...
                        <td class="auto-style5">Hoş geldin <i><asp:Label runat="server" ID="lblUser"></asp:Label></td>
